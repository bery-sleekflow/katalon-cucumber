...
class ContactCreate {
	...
	def createContactWithCondition(String condition) {
		...
		// create contact
		WebUI.click(findTestObject('Object Repository/Web/ContactPage/ContactListPage/CreateNewContactButton'))
		switch (condition) {
			case "phone number only":
				phoneNumber = '62856412' + commonStep.randomNumberGenerator(3).toString()
				WebUI.focus(findTestObject('Object Repository/Web/ContactPage/ContactFormPage/PhoneNumberInput'))
				WebUI.clearText(findTestObject('Object Repository/Web/ContactPage/ContactFormPage/PhoneNumberInput'))
				WebUI.setText(findTestObject('Object Repository/Web/ContactPage/ContactFormPage/PhoneNumberInput'),phoneNumber)
				break;
			case "email only":
		...
		//save contact
		WebUI.click(findTestObject('Object Repository/Web/ContactPage/ContactFormPage/CreateButton'))
	}
	...
	def searchContact(String input) {
		WebUI.setText(findTestObject('Object Repository/Web/ContactPage/ContactListPage/SearchContactInput'), input)
		WebUI.sendKeys(findTestObject('Object Repository/Web/ContactPage/ContactListPage/SearchContactInput'), Keys.chord(Keys.ENTER))
	}
}